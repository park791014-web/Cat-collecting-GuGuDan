(function (global) {
  ...
  global.GugudanV2.cardPackConfig = {
    normalPack:{label:'기본 뽑기권',ticketType:'normalTickets',ticketCost:1,rarityRates:{normal:.50,rare:.30,hero:.15,legendary:.05}},
    premiumPack:{label:'고급 뽑기권',ticketType:'premiumTickets',ticketCost:1,rarityRates:{normal:0,rare:.60,hero:.30,legendary:.10}},
