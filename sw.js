var CACHE_NAME = "gugudan-nyanko-v2.0.17";
var ASSETS = [
  "/Cat-collecting-GuGuDan/",
  "/Cat-collecting-GuGuDan/index.html",
  "/Cat-collecting-GuGuDan/css/style.css?v=2.0.13",
  "/Cat-collecting-GuGuDan/css/phase56.css",
  "/Cat-collecting-GuGuDan/css/phase561.css",
  "/Cat-collecting-GuGuDan/css/phase562.css",
  "/Cat-collecting-GuGuDan/css/releasePatch.css?v=2.0.14",
  "/Cat-collecting-GuGuDan/js/app.js?v=2.0.13",
  "/Cat-collecting-GuGuDan/js/game/modeEngine.js?v=2.0.13",
  "/Cat-collecting-GuGuDan/js/game/adventureEngine.js?v=2.0.13",
